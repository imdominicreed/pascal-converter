...
programIdentifier
	locals[ SymtabEntry entry = null ]: IDENTIFIER;
...
caseConstant
	locals[ Typespec type = null, int value = 0 ]: constant;
...
simpleExpression
	locals[ Typespec type = null ]: sign? term (addOp term)*;
